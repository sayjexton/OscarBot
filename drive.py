...
# Motors
front_left_motor = Motor(forward=25, backward=24)
back_left_motor = Motor(forward=7, backward=8)
back_right_motor = Motor(forward=22, backward=4)
front_right_motor = Motor(forward=9, backward=10)
